...
const Dither = memo(function Dither({
  ...
  // Custom shallow check so inline array props like waveColor don't bypass React.memo
  return (
    prevProps.waveSpeed === nextProps.waveSpeed &&
    prevProps.waveFrequency === nextProps.waveFrequency &&
    prevProps.waveAmplitude === nextProps.waveAmplitude &&
    prevProps.colorNum === nextProps.colorNum &&
    ...
    prevProps.waveColor.length === nextProps.waveColor.length &&
    prevProps.waveColor.every((val, index) => val === nextProps.waveColor[index])
  );
});
